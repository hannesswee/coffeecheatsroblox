-- Coffee Cheats - Universal Aimbot
...
local function createUI()
    ...
    logo.Image = "rbxassetid://129155200827929"
...
local function createSideTab(name, order, onClick)
    ...
    btn.Font = Enum.Font.GothamBold
    btn.TextSize = 16
    btn.TextColor3 = (name == activeTab) and Color3.fromRGB(255, 0, 0) or Color3.fromRGB(200, 200, 200)
    btn.Text = name
    btn.Parent = sideTabs
    ...
    btn.MouseButton1Click:Connect(function()
        ...
        for _, child in ipairs(sideTabs:GetChildren()) do
            if child:IsA("TextButton") then
                ...
                child.TextColor3 = isActive and Color3.fromRGB(255, 0, 0) or Color3.fromRGB(200, 200, 200)
